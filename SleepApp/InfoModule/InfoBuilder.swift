...
let sleepModesContent = ListenContent(author: "4 режима сна", title: "Режимы сна", images: [UIImage(named: "everyman") ?? UIImage(), UIImage(named: "dymaxion") ?? UIImage(), UIImage(named: "uberman") ?? UIImage()], text: """
...
let tipsForSleepingContent = ListenContent(author: "Советы для хорошего сна", title: "Советы", images: [UIImage(named: "son1") ?? UIImage(), UIImage(named: "son2") ?? UIImage(), UIImage(named: "zdSon") ?? UIImage()], text: """
Тишина
...
let importanceContent = ListenContent(author: "Факты о важности сна", title: "Факты", images: [UIImage(named: "vaj1") ?? UIImage(), UIImage(named: "vaj2") ?? UIImage(), nil], text: """
